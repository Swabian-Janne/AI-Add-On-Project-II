...
function generatePoem(event) {
  ...
  let context =
    "You are a poet who writes in the style of Goethe and other famous German poets of this time period. Your mission is to generate a 4 line poem in basic HTML. Make sure to follow the user instructions."; // giving the AI a "persona" to write in a specific style, so that the output is more accurate and relevant to the user's input
